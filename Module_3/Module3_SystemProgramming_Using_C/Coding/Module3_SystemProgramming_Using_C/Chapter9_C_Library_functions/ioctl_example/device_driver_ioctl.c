...
/*
**  function will be called when we read the Device file
*/
static ssize_t test_read(struct file *filp, char __user *buf, size_t len, loff_t *off)
{
...
/*
** function will be called when we write / read IOCTL on the Device file
*/
static long test_ioctl(struct file *file, unsigned int cmd, unsigned long arg)
{
         switch(cmd) {
...
static int __init test_driver_init(void)
{
        ...
        if(IS_ERR(dev_class = class_create(THIS_MODULE,"test_class"))){
